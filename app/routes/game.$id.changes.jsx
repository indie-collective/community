  ...
  return (
    <>
      <Box mb={5} pl={5} pr={5} mt={5}>
        <ChakraLink asChild><Link to={`/game/${id}`}>
            <LuArrowLeft />Back to game page
                    </Link></ChakraLink>
        <Flex direction="row" align="baseline" mt={5}>
          ...
          <Button ml="auto" asChild><Link to={`/game/${id}/edit`}><LuPencil />Edit game
                                    </Link></Button>
        </Flex>
      </Box>
      <Box mb={5} pl={5} pr={5} mt={5}>
  ...
  if (isRouteErrorResponse(error)) {
    return (
      <Stack textAlign="center" mt={20}>
        ...
        <Box mt={10}>
          <Button m="auto" mb={10} size="lg" colorPalette="green" asChild><Link to="/games/create"><LuPlus />Add a game
                                    </Link></Button>
        </Box>
      </Stack>
    );
